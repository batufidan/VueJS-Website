    ...
    <v-container fluid>
      <v-row>
        <v-col cols="12">
              ...
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
                    ...
                    class="d-none d-sm-none d-ml-flex"
                    filled solo prepend-icon="mdi-magnify" flat rounded outlined success
                    >
                    </v-text-field>
                  </v-col>
          ...
          <Product />
          <v-card flat color="#" class="rounded-xl mt-8">
          ...
          <Partner />
          <v-card flat color="#E2F2E5" class="rounded-xl stop mtop mbottom mx-10 pa-4" height="350">
            <v-row>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                ...
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempore asperiores odit, non debitis nemo cupiditate amet fuga molestias sit! Fugiat.</p>
